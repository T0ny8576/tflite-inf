...
if __name__ == "__main__":
    echo_cloudlet_profile = draw("vuzix-600-echo-1s.txt", "battery_echo_cloudlet.jpg", "Echo Cloudlet")
    od_cloudlet_classifier_profile = draw("vuzix-600-ed0-mpn-1s.txt", "battery_od_cloudlet_classifier.jpg",
                                          "ED0 + Cloudlet MPN COV")
    cloudlet_od_classifier_profile = draw("vuzix-600-frcnn-mpn-1s.txt", "battery_cloudlet_od_classifier.jpg",
